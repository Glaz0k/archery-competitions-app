...
CREATE INDEX ON "individual_groups" USING HASH ("competition_id");

CREATE INDEX ON "sparring_places" USING HASH ("competitor_id");

CREATE UNIQUE INDEX ON "ranges" ("group_id", "range_number");
