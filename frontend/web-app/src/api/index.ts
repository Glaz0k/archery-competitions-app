...
export type { CompetitorAdd, CompetitorToggle } from "./endpoints/competitors/types";
...
export { CompetitorAddSchema, CompetitorToggleSchema } from "./endpoints/competitors/schemas";
