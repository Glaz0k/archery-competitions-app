export { AddCompetitionModal } from "./components/competition/AddCompetitionModal";
export { DeleteCompetitionModal } from "./components/competition/DeleteCompetitionModal";

export { AddCupModal } from "./components/cup/AddCupModal";
export { DeleteCupModal } from "./components/cup/DeleteCupModal";
